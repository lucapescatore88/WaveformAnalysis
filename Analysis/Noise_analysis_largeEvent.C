...
int main(int argc, char* argv[]) 
{
    ...
    {    
        ...
        map<string,TH1D*> graphs {
           ...
           {"DeXT_arrivaltime", new TH1D(Form("Del_DiXT_arrival_times_%s",vol),"DeDiXT arrival times", 140, 0, 0.2e-6)},
        ...
        results["#Double"]->SetPoint(i,dV,perc_double*100.);
    ...
    formatGr(results["#SecPeaksDel"], kGreen+2, 0, "OverVoltage [V]", "<N Secondary peaks>");
